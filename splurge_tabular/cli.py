"""Command-line interface for the Splurge Tabular framework.
...
def main(args: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        prog="splurge-tabular",
        description="Splurge Tabular - Python tabular data processing framework",
    )
    ...
    parser.add_argument(
        "--version",
        action="version",
        version=f"splurge-tabular {__version__}",
    )
